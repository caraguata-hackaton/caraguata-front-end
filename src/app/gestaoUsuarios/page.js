...
import {AsideNavbar} from "@/app/components/AsideNavbar";
    ...
    return (
        <>
            ...
            <div className="flex min-h-screen bg-background relative">
                <AsideNavbar>
                    <AsideButton icon={ <LuTicketMinus size={20}/> } text="Chamados" destination="/painelChamados" />
                    <AsideButton icon={ <RiGraduationCapLine size={20}/> } text="Escolas" destination="/dadosUnidades"/>
                    <AsideButton icon={ <IoPersonOutline size={20}/> } text="Gestão de Usuários" destination="/gestaoUsuarios" active={true}/>
                </AsideNavbar>
                ...
                <main className="flex-1 flex flex-col">
                    <div className="w-[75%] max-w-6xl mx-auto py-12 px-8 flex flex-col gap-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div
                                className="p-6 bg-white rounded-3xl border border-azul-escuro border-opacity-30 shadow-sm flex flex-col gap-1">
                        ...
                        <div
                            className="flex items-center gap-4 p-2 bg-white/50 backdrop-blur-sm border border-azul-escuro border-opacity-30 rounded-xl">
                            ...
                            <div
                                className="relative flex items-center px-6 py-2 cursor-pointer hover:opacity-70 transition group">
                                <select
                                    value={filtroStatus}
                        ...
                        <div
                            className="bg-white rounded-3xl border border-azul-escuro border-opacity-10 shadow-sm flex flex-col overflow-hidden">
                            <div
                                className="grid grid-cols-12 px-8 py-5 bg-input-bg border-b border-azul-escuro border-opacity-20 items-center">
              <span className="col-span-4 text-azul-escuro text-xs font-bold uppercase tracking-widest">
                Nome
              </span>
                                <span
                                    className="col-span-2 text-azul-escuro text-xs font-bold uppercase tracking-widest">
                Matrícula
              </span>
                                <span
                                    className="col-span-3 text-azul-escuro text-xs font-bold uppercase tracking-widest">
                Escola
              </span>
                                <span
                                    className="col-span-2 text-azul-escuro text-xs font-bold uppercase tracking-widest">
                Status
                                ...
                                <span
                                    className="col-span-1 text-azul-escuro text-xs font-bold uppercase tracking-widest text-center">
                Ações
              </span>
                            </div>
                                    ...
                                    usuariosPaginados.map((usuario) => (
                                        ...
                                        >
                                            <div className="col-span-4 flex items-center gap-4">
                                                <div
                                                    className="w-10 h-10 bg-verde-pastel rounded-full flex justify-center items-center">
