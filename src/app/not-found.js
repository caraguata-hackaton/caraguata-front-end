  ...
  return (
    <div className="flex flex-col flex-1 items-center justify-center h-screen">
      ...
      <button
        type="button"
        onClick={() => router.back()}
        className="bg-azul-escuro cursor-pointer text-white font-medium py-2.5 px-6 rounded-md flex items-center gap-2 mt-10 hover:opacity-90 transition-opacity shadow-sm"
      >
