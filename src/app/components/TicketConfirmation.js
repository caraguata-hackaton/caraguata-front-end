...
export function TicketConfirmation({ isOpen }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
      ...
      <div className="bg-white rounded-4xl p-10 w-full max-w-2xl flex flex-col items-center text-center shadow-2xl animate-in fade-in zoom-in duration-200">
        ...
        <p className="text-black font-medium text-base leading-relaxed px-2 mb-8 max-w-md">
          Sua solicitação foi registrada e encaminhada para a nossa equipe. Lembre-se de que você pode editar as informações deste chamado por até 30 minutos.
        </p>

     
        <button 
          onClick={() => router.push("/homeEscola")} 
          className="bg-azul-escuro text-white font-bold tracking-wider rounded-lg py-4 px-8 w-full max-w-sm hover:bg-opacity-90 transition-opacity uppercase text-sm"
        >
